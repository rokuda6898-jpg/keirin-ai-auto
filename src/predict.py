...
header{{background:#fff;color:#17395f;padding:22px 18px 16px;border-bottom:5px solid #1d7de8}}.brand{{display:inline-block;background:#07182b;color:#fff;border-radius:8px;padding:13px 28px;font-size:27px;font-weight:900;letter-spacing:.12em;min-width:230px}}.tag{{display:inline-block;color:#1680ea;font-size:11px;font-weight:800;letter-spacing:.12em;margin-left:12px}}
